...
import {
  AccountListInfo, CampaignListInfo, CasesListInfo, TasksListInfo,
...
describe('TemporalStateServiceService', () => {
  ...
  function tasksParams(withOwner: boolean) {
    let p = createParams(SearchTaskInboxParams);
  ...
  it('current tasks list info', inject([TemporalStateServiceService], (service: TemporalStateServiceService) => {
    let s = tasksParams(true);
    service.tasksListInfo = createListInfo(TasksListInfo, s);

    checkListInfo(service.isCasesListInfo, service.redirectTo, false, "app/main");
    checkListInfo(service.isTaskListInfo, service.redirectTo,true, "app/main");
    checkListInfo(service.isCampaignListInfo, service.redirectTo,false, "app/main");
