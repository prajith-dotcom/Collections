...
import { ProcessInstanceComponent } from './views/process-instance/process-instance.component';
import { TaskInboxComponent } from './views/task-inbox/task-inbox.component';
import { TasksListTableComponent } from './views/tasks-list-table/tasks-list-table.component';
import { ProcessesListComponent } from './views/processes-list/processes-list.component';
import { ProcessesListTableComponent } from './views/processes-list-table/processes-list-table.component';
import { NewBpmProcessCaseComponent } from './views/new-bpm-process-case/new-bpm-process-case.component';
import { DiagramModalComponent } from './views/diagram-modal/diagram-modal.component';
import {DateAgoTransformPipe} from "./pipes/date-ago-transform.pipe";
import { DisasterModalComponent } from './views/disaster-modal/disaster-modal.component';
import { ImportManagementComponent } from './views/import-management/import-management.component';
...
@NgModule({
  declarations: [
    ...
    ProcessesListTableComponent,
    NewBpmProcessCaseComponent,
    DiagramModalComponent,
    DisasterModalComponent,
