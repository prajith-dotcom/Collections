...
export class ProcessCaseTickler {
  ...
  constructor(id?:number, caseId?:number, ticklerName?: string,ticklerTypeCode?:string, ticklerDescription?:string, createdBy?:string, createdDate?:string,  attributes?: CampaignListAttribute[], followUpDays?: number, document?: string){
    this.id = id;
    this.caseId = caseId;
