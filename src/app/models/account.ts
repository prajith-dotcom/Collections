...
export class AccountLoan {
  ...
  private _maturityDate: string;
  private _renewalDate: string;
  private _termDeposit: string;

  constructor(collateralInformation?: string, officer?: string, loanType?: string, currentBalance?: string, currentPayOff?: number, loanDate?: string,
              ...
              achAftFlag?: string, mortgageBalance?: number, mortgageBalanceUpdatedDate?: string, maturityDate?:string, renewalDate?:string, termDeposit?:string){
  ...
  set currentBalance(value: string) {
  ...
  get partiallyPaid(): string {
    return this._partiallyPaid;
  }

  set partiallyPaid(value: string) {
  ...
  get termDeposit(): string {
    return this._termDeposit;
  }

  set termDeposit(value: string) {
...
export class AccountBankruptcy {
  ...
  private _bankruptcyStatusDate: string;
  private _reaffirmationFlag: string;
  private _reaffirmationDate: string;
  ...
  constructor(bankruptcyType?: string, borrowerAttorneyInfo?: string, bankAttorneyInfo?: string, trusteeInfo?: string, dateFiled?: string, dateNoticeReceived?: string,
              ...
              actionStatus?: string, bankruptcyStopCodes?: string, caseStatus?: string, bankruptcyStatusDate?: string, reaffirmationFlag?: string, reaffirmationDate?: string){
    ...
    this.bankruptcyStatusDate = bankruptcyStatusDate;
    this.reaffirmationFlag = reaffirmationFlag;
    this.reaffirmationDate = reaffirmationDate;
  }
  ...
  get bankruptcyStatusDate(): string {
    return this._bankruptcyStatusDate;
  }

  set bankruptcyStatusDate(value: string) {
    this._bankruptcyStatusDate = value;
  }

  get reaffirmationFlag(): string {
    return this._reaffirmationFlag;
  }

  set reaffirmationFlag(value: string) {
    this._reaffirmationFlag = value;
  }

  get reaffirmationDate(): string {
    return this._reaffirmationDate;
  }

  set reaffirmationDate(value: string) {
    this._reaffirmationDate = value;
  }
}
...
export class AccountDep{
  ...
  get lastFSDate(): string{
    return this._lastFSDate;
  }

  set lastFSDate(value: string){
    this._lastFSDate = value;
  }
...
export class Account {
  ...
  private _processCase: BPMCase;
  private _processCases: BPMCase[];
  ...
  constructor(campaignRecordId?: string, accountId?: string, accountType?: string, customer?: Customer, relationDescription?: string,
              ...
              additionalInfo?: AccountAdditionalInfo, history?: AccountHistoryEntry[], processCase?: BPMCase, processCases?: BPMCase[],
              pastDueDays?: string, daysOverDrawn?: string)
  {
  ...
  get processCase(): BPMCase{
    return this._processCase;
  }

  set processCase(value: BPMCase){
    this._processCase = value;
  }

  get processCases(): BPMCase[]{
    return this._processCases;
  }

  set processCases(value: BPMCase[]){
    this._processCases = value;
  }
