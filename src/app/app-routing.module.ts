...
const routes: Routes = [
  ...
  // APP
  {
    ...
    children: [
      ...
      {path: `${UrlComponents.account}/:${PublicUrls.account.accountId}/:${PublicUrls.account.accountType}/:${PublicUrls.account.campaignRecord}/:${PublicUrls.account.tabId}/:${PublicUrls.account.objectId}`, component: ManageAccountComponent},
  ...
  // ADMIN
  {
    ...
    children: [
      ...
      {path: UrlComponents.imports, component: ImportManagementComponent}
    ]
  },
  // REPORTS
  {
