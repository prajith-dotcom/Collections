...
import {TasksListTableComponent} from "../tasks-list-table/tasks-list-table.component";
import {ProcessesListComponent} from "../processes-list/processes-list.component";
import {ProcessesListTableComponent} from "../processes-list-table/processes-list-table.component";
import {NewBpmProcessCaseComponent} from "../new-bpm-process-case/new-bpm-process-case.component";
...
describe('MainComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ MainComponent, FullSearchComponent, SearchComponent, ManageCasesComponent, NextCallComponent, SearchCriteriaComponent, SearchCaseCriteriaComponent,
                      ...
                      ConfirmationModalComponent, TaskInboxComponent, TasksListTableComponent, ProcessesListComponent, ProcessesListTableComponent, NewBpmProcessCaseComponent, DateAgoTransformPipe ],
  ...
  function onClickFilter(isFilterOne: boolean, isFilterTwo: boolean){
    if(isFilterOne){
      ...
      aParams.bankruptcyNumber = "16-51444";
  ...
  it('check account filter params when tab change ', fakeAsync(() => {
    ...
    checkHtmlServiceParams([ '',
      'SSN: 707',
      'Email address: email@gmail.com',
      'Account type: Deposit',
      'Account number: 1237',
      'Phone number: 123456789',
      'Bankruptcy Case number: 16-51444'
    ]);
  }));
  ...
  it('check html account search filter when collapse', fakeAsync(() => {
    ...
    refresh();
    onCollapseFilter();
    checkFilterParamsWhenCollapse(["707", "email@gmail.com", '123456789', "1237", "16-51444"], null);
  }));
  ...
  it('check tickler filter params when tab change ', fakeAsync(() => {
    ...
    checkRouter(["app/account", "122", "L", "0"]);
    onClickTab(1);
    onClickTab(2);
    onInit();
    refresh();
  ...
  it('check html tickler processes filter when collapse ', fakeAsync(() => {
    ...
    refresh();
    onCollapseFilter();
    checkFilterParamsWhenCollapse(["", "", "", "", "on", "on", "on"], null);
  }));
