import {
  async, ComponentFixture, discardPeriodicTasks, fakeAsync, flush, TestBed,
  tick
...
describe('ManageAccountComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ ManageAccountComponent, CustomerNotesComponent, TabCounterComponent, CustomerCallRecordsComponent, NewCallRecordComponent, IboxtoolsComponent,
                      ...
                      NewBpmProcessCaseComponent, ProcessInstanceComponent, DisasterModalComponent, DiagramModalComponent, DateAgoTransformPipe ],
  ...
  function checkBasicData(cName: string, cLastName: string, cCompleteName: string, address: string, pNumber: string, lineType: LineType, typeDescription: string, type: PhoneType,
                          ...
                          loanTerm: string, loanDate: string, loanRate: string, lBalance: string, lcurrentPayOff: number, addInfoEaPcFlag: string){
  ...
  function checkLoanData(collateralInformation: string, loanType: string, currentPayOff: number, loanTerm: string, ltv: string, lienPosition: number, officer: string,
                         currentBalance: string, loanDate: string, rate: string, appraisedAmount: number, updatedAppraisal: string){
  ...
  it('should be created', () => {
    injectSpy(DataService, 'bpm_getCases', dataServiceMock.bpmCases, false);
