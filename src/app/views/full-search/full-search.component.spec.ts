...
import {PamCommsService} from "../../services/pam-comms.service";
...
describe('FullSearchComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ FullSearchComponent, NextCallComponent, SearchCriteriaComponent, SearchCaseCriteriaComponent, WaitingBackendComponent, FilterCodeToNamePipe, ProcessesListComponent, TaskInboxComponent ],
      providers: [ {provide: GlobalStateService, useValue: globalStateServiceMock }, { provide: DataService, useValue: dataServiceMock }, BackendCommsService, PamCommsService, UserFeedbackService, DatePipe, BooleanToStringPipe,
