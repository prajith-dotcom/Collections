    ...
    */
    ...
    if (this.dateInput.nativeElement.value) {
      if(this.pickerType ==="calendar"){
        this.isInvalidFormat = !moment(this.dateInput.nativeElement.value, ["MM/DD/YYYY"], true).isValid();
      }
      else if (this.pickerType ==="both") {
        this.isInvalidHourFormat = !moment(this.dateInput.nativeElement.value, ["MM/DD/YYYY HH:mm"], true).isValid();
      }
    }
